...
const BurgerMenu: FC<MenuProps> = ({
  ...
  return (
    <div className="sm:hidden flex flex-1 justify-end items-end mr-5 flex-col">
      ...
      >
        <div className="absolute top-0 bottom-0 right-0 bg-gradient-to-r from-slate-200 to-slate-400 w-screen">
              ...
              {menu.map((item) => (
                <Link
                  ...
                  className={`mr-2 hover:underline underline-offset-1 ${
                    activeMenu === item.title ? "text-slate-400" : ""
                  }`}
                  key={item.id}
                >
